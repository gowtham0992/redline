...
class CliConfigTests(unittest.TestCase):
    def test_bare_cli_prints_first_run_help(self) -> None:
        ...
        self.assertIn("Recommended first run:", text)
        self.assertIn("redline app --demo", text)
        self.assertIn("Terminal-only demo:", text)
        self.assertIn("redline demo --public --compact", text)
        self.assertIn("redline quick-check logs/baseline.jsonl logs/candidate.jsonl --open-app", text)
        self.assertIn("Vocabulary:", text)
        self.assertIn("baseline", text)
        self.assertIn("known-good prompt/output log", text)
        self.assertIn("structural check", text)
        self.assertIn("redline import path/to/export.jsonl --detect", text)
        self.assertIn("docs/commands.md", text)
        self.assertIn("redline <command> --help", text)
        self.assertNotIn("Review loop:", text)
        self.assertNotIn("redline judges", text)
