...
| --- | --- |
| ![redline dashboard showing reports, benchmark evidence, history, and ship readiness](site/assets/redline-dashboard-proof.png) | ![redline HTML report showing concrete regression reasons and side-by-side baseline and candidate outputs](site/assets/redline-report-proof.png) |
